...
then
    ...
    ${libfm}/libFM -train $local_train_merge_feature -test $local_test_merge_feature -out $output_file -task c -save_model 'fm_110_local.model' -dim 1,1,10 -iter 100 -init_stdev 0.01
elif [ ${model} == 'gbdt' ]
then
